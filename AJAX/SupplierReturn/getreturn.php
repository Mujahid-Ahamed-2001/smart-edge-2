...
$sql = "SELECT SRDID,ProductID,products.ProdDescription,SD.UnitPurchasePrice,SD.VariationID,variations.VariationName,SD.Batch,SD.ReturnQty,SD.ReturnAmount FROM supplierreturndetails SD 
        ...
        WHERE SR.SRID = '".$srn_header_id."' ORDER BY SRDID DESC";
