    ...
    foreach ($productData as $row) 
    {
        ...
        if($row["ItemType"]=="P")
        {
            ...
            if(isset($inventoryData[0]["CurrentQty"]) && $inventoryData[0]["CurrentQty"] > 0)
            {
                ...
                ?>
                <a href="javascript:void(0)" class="col-md-4 product mb-2">
                    <div class="card product-card">
                        ...
                        <div class="product-detail p-2">
                            <p class="product-title">Title - <?=$row["ItemName"]?></p>
                            <p class="product-Barcode">Barcode - <?=$row["Barcode"]?></p>
                            <p class="product-sub-cat">Sub cat - <?=$row["SubCatName"]?></p>
                            <p class="product-typet"><?php 
                                if($row["ItemType"]=="P")
                                {
                                    echo "Type - Product";
                                }
            ...
            else
            {
                if($is_minus==1)
                {
                    ...
                    if(isset($inventoryData[0]["CurrentQty"]))
                    {
                        ...
                        $inventoryData['CurrentQty'] = $inventoryData[0]['CurrentQty'] * $row['UnitConversion'];
                        ?>
                        <a href="javascript:void(0)" class="col-md-4 product mb-2 subcat-<?=$row["SCID"]?>">
                            <div class="card product-card">
                                <div class="d-none">
                                    <input type="hidden" name="" id="productid" value="<?=$row["PDID"]?>">
                                </div>
                ...
                <a href="javascript:void(0)" class="col-md-4 product mb-2 subcat-<?=$row["SCID"]?>">
                    <div class="card product-card">
                        ...
                        <div class="product-detail p-2">
                            ...
                            {
                                ?>
                                <p class="product-sub-cat">Location - <?=$row["SubCatName"]?></p>
                                <?php
                            }
                            ?>
                        </div>
