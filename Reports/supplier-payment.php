                ...
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="from_date" class="form-control datepicker hasDatepicker" id="from_date" <?php if(isset($_GET["from_date"])){?>value="<?=$_GET["from_date"]?>"<?php } else{?> value="<?=date("Y-m-d")?>" <?php }?> placeholder="Start Date" >
                                </div> 
                            </div>
                            <div class="col-md-5">
                                  <div class="form-group">
                                    <label class="" for="to_date">End Date</label>
                                    <input type="date" name="to_date" class="form-control datepicker hasDatepicker" id="to_date" <?php if(isset($_GET["to_date"])){?>value="<?=$_GET["to_date"]?>"<?php } else{?> value="<?=date("Y-m-d")?>" <?php }?> placeholder="End Date">
                                </div>
                            </div>
                    ...
                    <thead>  
                        <tr>
                            ...
                            <th>Supplier Name</th>
                            <th>Product Name</th>
                            <th>Supplier Total Purchase Amount</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                        ...
                        {
                            $supplierpaymentdata = $supplierpayment->supplierpayment($shop_id);
                        }
                        ...
                        foreach ($supplierpaymentdata as $row) 
                        {
                            ...
                            <tr>
                                ...
                                <td> <?php echo $row['TotPurchase'] ?></td>
                            </tr>
                            <?php 
                            $i++;
                        }
