                        ...
                        <div class="card-body">
                            <form action="" method="get" class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label" for="to_date">Return Type</label>
                                            <select name="salesreturntype" id="salesreturntype" class="form-select">
                                            <?php 
                                            foreach($returnType AS $row)
                                            {
                                                ?>
                                                <option value="<?=$row["SRTID"]?>" 
                                                <?php 
                                                if(isset($_GET["salesreturntype"]) && $_GET["salesreturntype"]==$row["SRTID"])
                                                {
                                                    echo "selected";
                                                }
                                                ?>
                                ...
                                <table class="table table-hover" id="tbl_category">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET["from_date"]) && $_GET["to_date"])
                                        {
                                            ...
                                            $type=$_GET["salesreturntype"];
                                            $saleData = $saleObj->returninvoicereport($shop_id,$type,$from_date,$to_date);
                                        }
                                        else
                                        {
                                            $saleData = $saleObj->returninvoicereport($shop_id);
                                        }
                                        $i=1;
                                        $total_discount=0;
                                        $total_amount=0;
                                        ...
                                        if($count>0)
                                        {
                                            foreach ($saleData as $row) 
                                            {
                                                ...
                                                <tr>
                                                    <td> <?php echo $i;?> </td>
                                                    <td> <span class="badge bg-primary"><?=$row["SRT_Name"]?></span>
                                                    </td>
                                        ...
                                        else
                                        {
                                            ?>
                                            <tr>
                                                <td colspan="10"> <p class="text-danger text-center">No Results Found</p></td>
                                            </tr>
                                            <?php
                                        }                                        
                                        ?>
