                ...
                <div class="card">
                    ...
                    <tbody>
                        ...
                        foreach ($productData as $row) 
                        {
                            ...
                            $SubCatName = isset($row["SubCatName"]) && !empty($row["SubCatName"]) ? $row["SubCatName"] : "N/A"; 
                            $ItemName = isset($row["ItemName"]) && !empty($row["ItemName"]) ? $row["ItemName"] : "N/A"; 
                            $ProdDescription = isset($row["ProdDescription"]) && !empty($row["ProdDescription"]) ? $row["ProdDescription"] : "N/A"; 
                            $UnitName = isset($row["UnitName"]) && !empty($row["UnitName"]) ? $row["UnitName"] : "N/A"; 
                            $ProdPurchasePrice = isset($row["ProdPurchasePrice"]) && !empty($row["ProdPurchasePrice"]) ? $row["ProdPurchasePrice"] : "N/A"; 
                            $ProdSellPrice = isset($row["ProdSellPrice"]) && !empty($row["ProdSellPrice"]) ? $row["ProdSellPrice"] : "N/A"; 
                            ?>
                            <tr>
                                <td> <?php echo $i;?></td>
                                ...
                                <td> <?php echo $ProdDescription ?></td>
                                <td class="text-center"> <?php echo $UnitName ?></td>
                                <td class="text-end"> <?php echo $ProdPurchasePrice ?></td>
                                <td class="text-end"> <?php echo $ProdSellPrice ?></td>
                            </tr>
                            <?php 
                            $i++;
                        }
                    ...
                    <tr>
                        ...
                        <td class="text-end"><strong><?php echo number_format($product_purchase,2); ?></strong> <input type="hidden" name="product_purchase" id="product_purchase" value="<?=$product_purchase?>"></td>
                    </tr>
                    <tr>
                        <td colspan="6"></td>
                        <td><strong>Total Selling Price:</strong></td>
                        <td class="text-end"><strong><?php echo number_format($product_selling,2); ?></strong> <input type="hidden" name="product_selling" id="product_selling" value="<?=$product_selling?>"></td>
                    </tr>
                </tfoot>
                </table>
                </div>
