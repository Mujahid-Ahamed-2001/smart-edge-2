...
<body>
    ...
    <div class="h-100vh">
        <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <!-- Sidebar Start -->
            <?php 
            if(isset($_GET['ref']) && $_GET['ref'] == 'guipos') {
                ?>
                <style>
                    .body-wrapper
                    {
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php 
                                        $sql = "SELECT * FROM invoiceheader LEFT JOIN user ON user.USID = invoiceheader.user_USID WHERE customers_CTID = '$customer_id' AND shop_SHID = '$shop_id'";
