...
<body>
    <div class="toast toast-onload align-items-center text-bg-primary border-0 fade" role="alert" aria-live="assertive" aria-atomic="true" id="toast">
        <div class="toast-body hstack align-items-start gap-6">
            ...
            <div>
                <h5 class="text-white fs-3 mb-1">Welcome to Next Edge POS</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="order_form" action="" method="post" class="preDefault">
                                ...
                                $sql = "SELECT * FROM shopreceipts WHERE ReceiptStat = 1 AND shop_id='$shop_id' AND RecieptType=1";
                                $dbObj = new DBTransactions();
                                $dbData = $dbObj->getData($sql);
                                $invoices = empty($dbData) ? "retail-invoice.php" : $dbData[0]['ReceiptPath'];                            
                                ?>
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width:225px;">Unit Price</th>
                                                    <th style="width: 70px;">Discount Type</th>
                                                    <th style="width:225px;">Discount (Per Unit)</th>
                        ...
                        <div class="card-body">
                            <div class="product-cat">
                                <div class="row ">
                                    ...
                                    <div class="col-md-12 search-div mt-2">
                                        <div class="input-group">
