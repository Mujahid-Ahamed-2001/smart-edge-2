      ...
      <div class="d-flex align-items-center justify-content-center w-100">
        <div class="row justify-content-center w-100">
            ...
            <div class="card mb-0">
              <div class="card-body">
                <a href="index.php" class="text-nowrap logo-img text-center d-block py-3 w-100">
                  <img src="../Assets/Images/SystemLogo/Smart_edge_logo_3.png" width="300" alt="">
                </a>
                <?php  
          ...
          <div class="col-md-12 m-1">
                <p class="text-center" style="color:#2A3547; font-weight:600;"> Copyright &copy; <?=$current_year;?> By Smart Edge POS</p>
          </div>
          <!-- footer end  -->
        </div>
      </div>
