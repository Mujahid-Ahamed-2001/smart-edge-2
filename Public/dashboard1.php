...
<head>
  ...
  <style>
    ...
    a#Smart_edge_shop:hover 
    {
      background: #5d87ff ;
    }
    
    a#Smart_edge_shop:hover .card-title
    {
...
<body>
  <div class="toast toast-onload align-items-center text-bg-primary border-0 fade" role="alert" aria-live="assertive" aria-atomic="true" id="toast">
    <div class="toast-body hstack align-items-start gap-6">
      ...
      <div>
        <h5 class="colorwhite fs-3 mb-1">Welcome to Smart Edge</h5>
      </div>
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            ...
            {
              ?>
                <h5 class="card-title fw-semibold mb-4 colorwhite">Smart Edge Solutions</h5>
                <p class="mb-0 colorwhite">Please Select Your Shop 
                  <?php 
                  // if(isset($_COOKIE["remember_me_Smart_edge"])) echo $_COOKIE["remember_me_Smart_edge"]
                  ?>
                </p>
                  ...
                  else
                  {
                    foreach ($comData as $row) 
                    {
                      ...
                      <div class="col-md-3 p-1">
                        ...
                        <button type="submit" name="btn_continue" class="card" id="Smart_edge_shop"
                        <?php 
                        if($date>$row["ComExpireDate"] || $row["ComStat"]==0)
                        {
                          if($user[0]["UserType"]==0)
                            ...
                            <div class="row">
                              ...
                              <div class="row">
                                  <div class="col-md-12 " style="display:flex; justify-content:center;">
                                      <img src="../Assets/Images/icons/clothing-shop.gif" class="w-50 rounded-circle" alt="">
                                  </div>
                                  <?php 
                                  if($date>$row["ComExpireDate"] || $row["ComStat"]==0)
                                  {
                                  ...
                                  if($date>$row["ComExpireDate"] ||  $row["ComStat"]==0)
                                  {
                                    if($user[0]["UserType"]==0)
                                    {
                                      if( $row["ComStat"]==0)
                                      {
                                        ...
                                        <div class="col-md-12 m-2">
                                          <h6 class="card-title mb-4 text-center" style="font-size:14px; color:#ff0000;">
                                            <b>Company Inactive. Please Contact Smart Edge.</b>
                                          </h6>
                                        </div>
                                        <?php
                                      }
                                      else
                                      {
                                        ...
                                        <div class="col-md-12 m-2">
                                          <h6 class="card-title mb-4 text-center" style="font-size:14px; color:#ff0000;">
                                            <b>Company Expired. Please Contact Smart Edge.</b>
                                          </h6>
                                        </div>
                                        <?php
            ...
            {
              ?>
              <h2 class="card-title" style="color:#ff0000;">
                If you didn't have a shop please try our trial version or Contact Smart Edge
                <br>
                Smart Edge Solutions (PVT) LTD
              </h2>
              <?php
            }//no shop or company
            ?>
