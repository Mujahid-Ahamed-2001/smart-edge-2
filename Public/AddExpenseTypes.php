            ...
            <div class="body-wrapper">
                ...
                <div class="container-fluid py-4">                       
                    <div class="page-breadcrumb d-flex align-items-center mb-4">
                        ...
                        <span class="breadcrumb-active">Add Expense Types</span>
                    </div>
                    <div class="expense-card">
                        ...
                        <div class="expense-card-header">
                            ...
                            <div class="expense-title">
                                ...
                                <div>
                                    <h3>Expense Types <a href="javascript:void(0)" id="refresh"><i class="ti ti-reload"></i></a></h3>
                                    <p>Create and manage different types of expenses</p>
                                </div>
                            ...
                            {
                                ?>
                                <a class="btn btn-add-expense open-modal" href="../View/modals/expense-types.php?condition=new&ref=AddExpenseTypes" data-title="Add Expense Type">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table expense-table align-middle" id="tbl_expense_type">
                                <thead>
                                    <tr>
                                        <th width="80">ID</th>
                                        <th width="450">Expense Type</th>
                    ...
                    <script src="../Assets/jquery/AddExpenseType2.js"></script>
                    <!-- footer End  -->
                </div>
            </div>
        </div>
