      ...
      <div class="d-flex align-items-center justify-content-center w-100" style="margin-top :80px;">
        <div class="row justify-content-center w-100">
          <div class="col-md-8 col-lg-4 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body" style="padding: 10px 30px !important;">
                <a href="index.php" class="text-nowrap logo-img text-center d-block pb-1 w-100">
                  <img src="../Assets/Images/SystemLogo/Smart_edge_logo_3.png" width="150" alt="">
                </a>
                <?php  
          ...
          <div class="col-md-12 m-1">
                <p class="text-center" style="color:#fff; font-weight:600;"> Copyright &copy; <?=$current_year;?> By Smart Edge POS</p>
          </div>
          <!-- footer end  -->
        </div>
      </div>
