...
{
    $transfer_header_id = $_POST['transfer_header_id'];
    $transfer_header_stat = $_POST['transfer_header_stat'];
}//id set
else
{
                    ...
                    <form action="../Controller/transferController.php" method="POST">
                        ...
                        <div class="row m-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" id="transfer_amount" name="transfer_amount" class="form-control mb-2" placeholder="Enter Amount" required>
                            </div>
                        </div>
...
<!--  Body Wrapper End -->
    ...
    <script src="../Assets/jquery/transfer_details.js"></script>
