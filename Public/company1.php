...
<div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
        ...
        <div class="container">
            ...
            <h5 class="card-title fw-semibold mb-3" style="margin-top: 0px;">Company</h5>
            <?php 
            if(isset($_SESSION['company_update']))
            {
                if ($_SESSION['company_update']==0) 
            ...
            <div class="card">
                <div class="card-body">
                    <button class="btn btn-primary ml-1 mb-3" id="btn_add_company">Add Company</button>                    
                    <div class="container-fluid">
                        <table class="table table-responsive table-hover" id="tbl_company">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Logo</th>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    {
                                        $ComLogo="../Assets/Images/Company_Logos/".$row['ComLogo'];
                                        if(file_exists($ComLogo) && !empty($row['ComLogo']))
                                        {
                                            $ComLogo="../Assets/Images/Company_Logos/".$row['ComLogo'];
                                        }
                                        else
                                        {
                                            $ComLogo="../Assets/Images/Company_Logos/smart_edge_logo.png";
                                        }
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="<?=$ComLogo?>" alt="Comapny Logo" class="img-fluid rounded-circle" style="width:100px; heigh:auto;">
                                            </td><!-- 2 -->
                                            ...
                                            <td>
                                                ...
                                                {
                                                    ?>
                                                    <p class="text-center" style="font-weight: 700;"><span class="badge bg-success"><i class="ti ti-checks"></i> Active</p></span>
                                                    <?php 
                                                }//active company
                                                else
                                                {
                                                    ?>
                                                    <p class="text-center" style="font-weight: 700;"><span class="badge bg-danger"><i class="ti ti-circle-x"></i> Inactive</span></p>
                                                    <?php 
                                                }//inactive company
                                                ?>
                                            </td><!-- 7 -->
                                            <td>
                                                <div class="d-flex justify-content-evenly">
                                                    <button type="button" id="btn_company_<?php echo $row['CMID']?>" class="btn btn-primary btn_edit_company"><i class="ti ti-edit"></i></button>
                                                    <button type="button" id="btn_company_delete_<?php echo $row['CMID']?>" class="btn btn-danger"><i class="ti ti-x"></i></button>    
                                                </div>
