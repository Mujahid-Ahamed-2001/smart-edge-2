  ...
  <!--  Body Wrapper -->
    <div class="h-100vh">
        ...
        data-sidebar-position="fixed" data-header-position="fixed">
            ...
            <!--  Header Start -->
                ...
                ?>
                <!--  Header End -->
                <div class="container-fluid dark_background">
                  <?php 
    ...
    <div class="row">
      <div class="card col-md-8 pt-3">
          <div class="row">
              <div class="col-6">
                <select name="cmb_chart_type" id="cmb_chart_type" class="border border-primary form-select color_white">
      ...
      <div class="col-md-4" id="div_other_charts">
          <div class="card p-2">
            <h5 class="card-title mb-2 fw-semibold px-2 color_white">
              Today Revenue
            ...
            <div class="row">
                <div class="col-6 p-2">
                  ...
                  ?>
                  <h4 class="p-2 color_white"><?php echo "Rs: " . number_format((float)$gross_sale, 2, '.', '');?></h4>

                  <p class="p-3 mb-1 color_white">
          ...
          <div class="card p-2">
            ...
            <div>
              ...
              ?>
              <h4 class="p-2 m-0 color_white"><?php echo "Rs: " . $purchase_total;?></h4>
              <!-- line chart -->
    ...
    <div class="row mt-2">
      ...
      <div class="col-md-4">
        <div class="card p-3" style="height: 450px;">
          <h5 class="color_white">Fast Moving Items</h5>
          <table>
            <tr>
              <th class="color_white">Item Name</th>
              <th class="color_white">Sold Qty</th>
            </tr>
            <?php 
            //get current date time
            date_default_timezone_set("Asia/Colombo");
            ...
            foreach($itemData as $row)
            {
              ?>
                <tr>
                  <td class="color_white"><?php  echo $row['ItemName'];?></td>
                  <td class="color_white"><?php  echo $row['TotalSaleQty'] + 0;?></td>
                </tr>
              <?php 
            }//foreach
            ?>
      ...
      <div class="col-md-8">
        <div class="card p-3" style="height: 450px;">
          <h5 class="color_white">Recent transactions</h5>
          <table>
            <tr>
              <th class="color_white">Bill No</th>
              <th class="color_white">Date</th>
              <th class="color_white">Time</th>
              <th class="color_white">Customer</th>
              <th class="color_white">Amount</th>
            </tr>
          <?php 
        ...
        ?>
          <div class="card mt-2">
            <div class="card-header">
              <h5 class="color_white">Sooner Expiring Items</h5>
            </div>
            <div class="card-body">
              <table>
                <tr>
                  <th class="color_white">Barcode</th>
                  <th class="color_white">Item Name</th>
                  <th class="color_white">Qty</th>
                  <th class="color_white">Price</th>
                  <th class="color_white">Added Date</th>
                  <th class="color_white">Exp date</th>
                  <th class="color_white">Expire</th>
                </tr>
                <?php 
                  //get current date time
                  date_default_timezone_set("Asia/Colombo");
                  ...
                  foreach($expData as $row)
                  {
                    ...
                    ?>
                    <tr>
                      <td class="color_white"><?php echo $row['Barcode'];?></td>
                      <td class="color_white"><?php echo $row['ItemName'];?></td>
                      <td class="color_white"><?php echo $row['CurrentQty'] + 0;?></td>
                      <td class="color_white"><?php echo $row['SellingPrice'];?></td>
                      <td class="color_white"><?php echo $row['EffectiveDate'];?></td>
                      <td class="color_white"><?php echo $row['ExpDate'];?></td>
                      <td class="color_white">
                        <?php 
                          if($days_to_expire >0 AND $days_to_expire < 7)
                          {
                            ?>
                            <p style="font-weight: bold;"><?php echo $days_to_expire;?> Days</p>
                            <?php 
                          }//7 days
