                                            ...
                                            ?>  
                                                ...
                                                <tr data-id="<?php echo $row['SHID'];?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        {
                                                            $shopLogo="../Assets/Images/SystemLogo/Smart_edge_logo_3.png";
                                                        }
                                                    ...
                                                    <?php 
                                                        ...
                                                        {
                                                            $ReceiptLogo="../Assets/Images/SystemLogo/Smart_edge_logo_3.png";
                                                        }
                                                    ...
                                                    <td>
                                                        <?php 
                                                        $ShopPermissions = $shopObj->getShopPermissions($row['SHID']);
                                                        foreach ($ShopPermissions as $value) 
                                                        {
                                                            if($value["SFstatus"]==1)
                                                            {
                                                               ?>
                                                                    <span class="badge bg-primary mt-2"><?=$value["FeatureName"]?></span><br>
                                                                <?php 
                                                            }
                                                            else
                                                            {
                                                               ?>
                                                                    <span class="badge bg-danger mt-2"><?=$value["FeatureName"]?></span><br>
                                                                <?php
                                                            }
                                                    ...
                                                    {
                                                        $shopLogo="Smart_edge_logo_3.pngg";
                                                    }
                                                    echo $shopLogo;
                                                    ?></td><!-- 28 -->
                                                    <td style="display:none"><?php 
                                                        ...
                                                        {
                                                            $ReceiptLogo="Smart_edge_logo_3.png";
                                                        }
                                                    echo $ReceiptLogo;
                                                    ?></td><!-- 29 -->
