...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 23, 2026 at 08:37 PM
...
CREATE TABLE `adjustproddetails` (
  ...
  `AdjustStat` int(11) DEFAULT NULL COMMENT '0 = Hold\r\n1 = Pending\r\n2 = Verfified\r\n3 = Cancelled',
...
(1, 'CM-00001', 'Next Edge Solutions', 'Panadura', '00001', '1.1', NULL, '2026-04-17', NULL, 1, 0, 0, 1, '2026-06-21');
...
(1, 'CU-00001', 'Common Customer', 1, NULL, 'Panadura', '', '0712345678', 100000.00, NULL, 1, 1, NULL, '2026-08-02');
...
(1, 'up_Artboard 1 (1).jpg', 'Admin', 'admin@next-edge.lk', '0770206960', '63afea2fba5359682f704b79640cb803', NULL, 1, 1, 1, 0.00);
