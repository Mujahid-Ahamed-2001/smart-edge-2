...
else if(isset($_GET["invoice_id"]))
{
    ...
    //get shop details
        ...
        LEFT JOIN salesmans ON salesmans.SLID = invoiceheader.Salesmans_SLID
        ...
        $receiptText= $headData[0]['receiptText'];
        ...
        $InvStat=$headData[0]['InvStat'];
        $SalesmansName=$headData[0]['SalesmansName'];
...
<head>
    ...
    <script src="../Assets/jquery/JsBarcode.min.js"></script>
...
<body>
    ...
    <div>
        ...
        <div style="display:flex; justify-content:center; width: 100%; margin-bottom: 15px;">
            <img src="../Assets/Images/shop_images/<?php echo $receipt_logo_name;?>" alt="shop logo" id="img_receipt" style="border-radius: 5px;">    
        ...
        {
            ?>
            <h2 style="text-align: center;">Cancelled Invoice</h2>
            <?php
        }
        ?>
    ...
    <div>
        <table id="tbl_bill_detail">
            ...
            <tr>
                <td class="td_bill_detail">Salesman: </td>
                <td class="td_bill_detail td_data"><?php echo $SalesmansName?></td>
            </tr>
        </table>
    </div>
    ...
    <div>
        ...
        <tr style="font-size: 11px;">
            <td style="text-align: right;">Number of Qty:</td>
            <td style="text-align: right;"><?php echo $row_qty;?></td>
        </tr>
        </table>
    </div>
    ...
    <!-------------------------- Footer -------------------------->
    <p id="p_footer">
        Powered by : Next Edge IT Solution PVT(LTD) +94-770206960
    </p>
