...
if (isset($_POST['btn_verify_srn'])) {
    ...
    WHERE SR.SRID = '" . htmlspecialchars($srn_header_id) . "'
    ORDER BY SRDID DESC";
    ...
    foreach ($dbData as $row) {
        ...
        // echo "rtn_qty $rtn_qty <br>";
        // echo "item_purchase_total $item_purchase_total <br>";
        // echo "total_purchase_price $total_purchase_price <br>";
