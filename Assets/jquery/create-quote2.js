...
let option_html = `<div class="option card p-2 mt-3" id="option-${option_no}" data-option-no="${option_no}">
                                            <div class="d-flex justify-between m-3">
                                                <div class="w-50">
                                                    <h5 class="title"><strong class="d-flex align-items-center text-primary"><i class="ti ti-folder"></i><input type="text" class="border-0 form-control text-primary bg-transparent fw-bolder" name="options_name[]"  value="Option ${option_no}"/></strong> </h5>    
                                                </div>
                                                <div class="w-50">
                                                    <div class="d-flex justify-content-end w-100" id="action${option_no}">
                                                        ...
                                                        <a href="javascript:void(0);" class="btn btn-danger delete_option" id="delete_option" data-option-no="${option_no}"><i class="ti ti-trash-x"></i>Option</a> 
                                                    </div>
                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="text-align:center;"><a href="javascript:void(0);" class="btn btn-primary me-2 add-row" id="add-row-${option_no}" data-option-no="${option_no}"><i class="ti ti-plus"></i></a></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="tbl_item_${option_no}">
                                                        <tr class="item-row">
                                                            <td style="min-width:250px;max-width: 350px !important;">
                                                            ...
                                                            <td style="min-width:100px;">
                                                                <input type="number" name="options[${option_no}][items][${row_index}][cost]" id="cost_${option_no}_${row_index}" class="form-control cost" step="0.01" readonly>
                                                            </td>
                                                            <td style="min-width:100px;">
                                                            ...
                                                            <td>
                                                                <div class="d-flex justify-content-end" id="action">
                                                                    <a href="javascript:void(0);" class="btn btn-warning me-2 duplicate-row" id="duplicate-row-${option_no}-${row_index}" data-option-no="${option_no}" data-row-index="${row_index}"><i class="ti ti-copy"></i></a>
                                                                    <a href="javascript:void(0);" class="btn btn-danger delete-row" id="delete-row-${option_no}-${row_index}" data-option-no="${option_no}" data-row-index="${row_index}"><i class="ti ti-trash-x"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    <tfoot>
                                                        <tr class=" border-none bg-new">
                                                            <td colspan="7" class="text-end left-border bg-new"><b>Sub Total</b></td>
                                                            <td class=" border-none bg-new"><input type="number" name="options[${option_no}][subtotal]" id="sub_total_${option_no}" class="form-control" step="0.01" readonly></td>
                                                            <td class=" right-border bg-new"></td>
                                                        </tr>
                                                        <tr class=" border-none bg-new">
                                                            <td colspan="6" class="text-end left-border bg-new"><b>Sale Discount Type</b></td>
                                                            <td class=" border-none bg-new">
                                                                <select name="options[${option_no}][sale_discount_type]" id="sale_discount_type_${option_no}" class="form-select">
                                                                    <option value="1">%</option>
                                                                    <option value="2">Flat</option>
                                                                </select>
                                                            </td>
                                                            <td class=" border-none bg-new"><input type="number" name="options[${option_no}][sale_discount_amount]" id="sale_discount_amount_${option_no}" class="form-control" step="0.01"></td>
                                                            <td class=" right-border bg-new"></td>
                                                        </tr>
                                                        <tr class=" border-none bg-new">
                                                            <td colspan="7" class="text-end left-border bg-new"><b>Total Discount</b></td>
                                                            <td class=" border-none bg-new"><input type="number" name="options[${option_no}][total_discount]" id="total_discount_${option_no}" class="form-control" step="0.01" readonly></td>
                                                            <td class=" right-border bg-new"></td>
                                                        </tr>
                                                        <tr class=" border-none bg-new">
                                                            <td colspan="7" class="text-end left-border bg-new"><b>Other Charges</b></td>
                                                            <td class=" border-none bg-new"><input type="number" name="options[${option_no}][other_charges]" id="other_charges_${option_no}" class="form-control" step="0.01"></td>
                                                            <td class=" right-border bg-new"></td>
                                                        </tr>
                                                        <tr class=" border-none bg-new">
                                                            <td colspan="7" class="text-end left-border bg-new" style="border-bottom: 1px solid #dfdfdf !important"><b>Grand Total</b></td>
                                                            <td class=" border-none bg-new" style="border-bottom: 1px solid #dfdfdf !important"><input type="number" name="options[${option_no}][grand_total]" id="grand_total_${option_no}" class="form-control" step="0.01" readonly></td>
                                                            <td class=" right-border bg-new" style="border-bottom: 1px solid #dfdfdf !important"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>    
...
function customerChange(customerData)
{

    $("#customer_text").html(customerData.text);
    $("#customer-avatar").html(customerData.initials);
    if(customerData.id==1 || customerData.id=="1" || customerData.id=="" || customerData.id==null || customerData.id==undefined || customerData.id=="Add") 
    {
        $("#customer-profile-link").attr("href", "javascript:void(0);");
        $("#customer-edit-link").attr("href", "javascript:void(0);");

    }
    else
    {
        $("#customer-profile-link").attr("href",customerData.customerProfile);
        $("#customer-edit-link").attr("href",customerData.editCustomer); 
    }
...
function initcustomerSelect(element) {
    $(element).select2({
        ajax: {
            url: '../AJAX/Quotation/getCustomers.php?ref=create-quote2',
            dataType: 'json',
            delay: 250,
            data: function(params){
                return {
...
$(document).ready(function(){
    ...
    $(document).on('click', '.open-modal', function (e) {
      ...
      var cmb_customer = $("#cmb_customer").val();
    ...
    $("#cmb_customer").on("select2:select", function(e){
        ...
        if(data.id === "Add") 
        {
            ...
            openModal("../View/modals/customer-modal.php?condition=new&ref=create-quote2","Add Customer");
        }
        else
        {
            customerChange(data);
