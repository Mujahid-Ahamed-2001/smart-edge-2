...
$("#tbl_products").on('click', '.btn_edit_product', function(){
    ...
    $.get("../AJAX/Products/getOneProduct.php", {
        ...
        var category_id = obj[0]['CTID'] || 0;
        var subcategory_id = obj[0]['SCID'] || 0;
...
$("#tbl_products").on('click', '.btn_open_barcode', function(){
    let row = $(this).closest('tr');
    let id = row.data('id');
...
$("#btn_close_barcode_modal").click(function(){
    $("#product_barcode_modal").modal('hide');
});
