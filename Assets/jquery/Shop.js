...
$(document).ready(function(){
    ...
    $('#btn_Add_Shop_modal').click(function(){      
        ...
        $("#ShopFeatures").load("../Ajax/ShopFeatures/getshopfeatures.php");
        ...
        var url = "../Assets/Images/SystemLogo/smart_edge_logo.png";
    ...
    $("#tbl_shop").on('click', '.btn_edit_shop', function(){
        ...
        $.get("../AJAX/Shops/getOneShop.php", {
            ...
            var defaulteUrl  = "../Assets/Images/SystemLogo/smart_edge_logo.png";
            ...
            $("#ShopFeatures").load("../Ajax/ShopFeatures/getshopfeatures.php?SHID="+id);
