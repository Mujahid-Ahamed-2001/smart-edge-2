...
$(document).ready(function(){
  var html = '<div id="modal2"></div>';
  $("#modern-header").prepend(html);
...
$('#ue-cpassword').keydown(function(){
  ...
  function getNoteTotal()
  {
    ...
    counter_total = rs_5000 + rs_1000 + rs_500 + rs_100 + rs_50 + rs_20 + rs_10 + rs_5 + rs_2 + rs_1;
    console.log("rs_5000 "+rs_5000);
    console.log("rs_1000 "+rs_1000);
    console.log("rs_500 "+rs_500);
    console.log("rs_100 "+rs_100);
    console.log("rs_50 "+rs_50);
    console.log("rs_20 "+rs_20);
    console.log("rs_10 "+rs_10);
    console.log("rs_5 "+rs_5);
    console.log("rs_2 "+rs_2);
    console.log("rs_1 "+rs_1);
    console.log("counter_total "+counter_total);
...
$(document).ready(function () {
    ...
    const $toggleBtn = $("#headerCollapse2");
    const $toggleBtn2 = $("#sidebarCollapse");

    // ===== Toggle Sidebar =====
    function toggleSidebar() {
        $main.toggleClass("sidebar-collapsed");
        $toggleBtn.css("display:block;");
        $toggleBtn2.css("display:block;");
    }
        $toggleBtn.css("display:block;");
        $toggleBtn2.css("display:block;");
        setTimeout(() => {
    ...
    $(document).on("click", function (e) {
        ...
        const isCollapsed = $main.hasClass("sidebar-collapsed");
        const clickedInsideSidebar = $(e.target).closest(".left-sidebar").length;
        const clickedToggle = $(e.target).closest("#headerCollapse2").length;

        // If sidebar is OPEN and click is outside → close it
        if (!isCollapsed && !clickedInsideSidebar && !clickedToggle) {
