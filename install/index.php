...
<body>
	<header class="bg-white py-2 text-center">
		<div class="container">
			<h3 class="title">
				<img src="../Assets/Images/SystemLogo/Smart_edge_logo_3.png" alt="" class="logo w-10">
			</h3>
		</div>
	</header>
	<div class="installation-section bg-white padding-bottom padding-top">
		<div class="container">
			<?php 
			error_reporting(0);
			...
			if ($action=='complete') {
								...
								<div class="success-area text-center">
									...
									if ($_POST) 
									{
										...
										$envcontent = <<<PHP
													...
													PHP;
										$indexPath=dirname(__DIR__, 1) . '/index.php';
										$file_contents=file_get_contents($indexPath);
										$file_contents=str_replace("production","live",$file_contents);
										file_put_contents($indexPath,$file_contents);
										$status = 'ok';
										$envpath = dirname(__DIR__, 1) . '/Includes/config.php';
										...
										if ($status == 'ok') 
										{
											...
											if(setAdminEmail($alldata))
											{
												...
												$sql = "UPDATE user SET UserEmail='".$email."',UserPwd='$admin_password' WHERE UserName='Admin'";
												$stmt = $db->prepare($sql);
												$stmt->execute();
												...
												<a href="'.getWebURL().'/admin" class="theme-button choto">Go toAdmin Panel</a>
												</div>';
				...
				<div class="installation-wrapper">
					<div class="install-content-area">
						<div class="install-item">
							<h3 class="bg-primary title text-center">Installation Information</h3>
							<div class="box-item">
									...
									<div class="info-item">
										...
										<div class="row">
											<div class="information-form-group col-lg-3 col-sm-6">
												...
												<input type="text" value="Admin" name="admin_username" class="bg-dark" disabled>
											</div>
											<div class="information-form-group col-lg-3 col-sm-6">
												<label>Password</label>
												<input type="password" value="admin" name="admin_password">
											</div>
				...
				<div class="installation-wrapper">
					<div class="install-content-area">
						<div class="install-item">
							<h3 class="bg-primary title text-center">File Permissions</h3>
							<div class="box-item">
				...
				<div class="installation-wrapper">
					<div class="install-content-area">
						<div class="install-item">
							<h3 class="bg-primary title text-center">Server Requirments</h3>
							<div class="box-item">
								<div class="item table-area">
									<table class="requirment-table">
										<?php
				...
				<div class="installation-wrapper">
					<div class="install-content-area">
						<div class="install-item">
							<h3 class="bg-primary title text-center">Terms of Use</h3>
							<div class="box-item">
								<div class="item">
	...
	<footer class="bg-white py-3 text-center">
		<div class="container">
			<p class="m-0 font-weight-bold text-dark">&copy;<?php echo Date('Y') ?> - All Right Reserved by <a href="https://Next-edge.lk/">Next Edge Solutions</a></p>
		</div>
	</footer>
	<style>
		#hide{
