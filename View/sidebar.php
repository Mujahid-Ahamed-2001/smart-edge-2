  ...
  <div>
    <div class="sidebar-header">
      ...
      <div class="sidebar-logo">
          ...
          <img
              src="../Assets/Images/SystemLogo/Smart_Edge_logo_2.png"
              alt="Smart Edge">
    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
      <ul id="sidebarnav">
        ...
        if($userType==1)
        {
          ...
          <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
            <span class="menu-icon-wrapper">
              <i class="ti ti-cash-banknote menu-icon"></i>
            </span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
              <span class="menu-icon-wrapper">
                <i class="ti ti-message-chatbot menu-icon"></i>
              </span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
              <span class="menu-icon-wrapper">
                <i class="ti ti-adjustments-alt menu-icon"></i>
              </span>
  ...
  <!-- End Sidebar scroll-->
   <div class="sidebar-user-card">
    <?php 
            ...
            ?>
    <img src="<?php echo $complogoa;?>" style="object-fit:cover;">
