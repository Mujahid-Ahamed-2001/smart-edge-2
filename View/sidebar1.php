...
<aside class="left-sidebar">
  ...
  <div>
    <div class="brand-logo d-flex align-items-center justify-content-between">
      <a href="../Public/home.php" class="text-nowrap logo-img  d-flex align-items-center justify-content-center">
        <img src="../Assets/Images/SystemLogo/Smart_Edge_logo_2.png" class="w-40" alt="" />
      </a>
        ...
        if($userType==1)
        {
            ...
            <ul aria-expanded="false" class="collapse first-level">
              ...
              <li class="sidebar-item">
                <a href="../Public/grn-header.php" class="sidebar-link">
                  ...
                  <span class="hide-menu">Good Receive</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a href="../Public/adjust-header.php" class="sidebar-link">
                  ...
                  <span class="hide-menu">Adjustments</span>
                </a>
              </li>
              <li class="sidebar-item">
              ...
              <li class="sidebar-item">
                <a href="../Public/supplier-cheque-list.php" class="sidebar-link">
                  ...
                  <span class="hide-menu">Supplier Cheque List</span>
                </a>
              </li>
            </ul>
          </li>
            ...
            <ul aria-expanded="false" class="collapse first-level">
              ...
              <li class="sidebar-item">
                <a href="../Public/gui-pos.php" class="sidebar-link sidebar-link2">
                  ...
                  <span class="hide-menu">POS Sale</span><span class="badge text-bg-secondary">New</span>
                </a>
              </li>
              <?php 
              }
              ...
              ?>
              <li class="sidebar-item">
                <a href="../Public/create-quote.php" class="sidebar-link sidebar-link2">
                  <div class="round-16 d-flex align-items-center justify-content-center">
                    <i class="ti ti-circle"></i>
                  </div>
                  <span class="hide-menu">Create Quotation</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a href="../Public/view-quote.php" class="sidebar-link sidebar-link2">
                  <div class="round-16 d-flex align-items-center justify-content-center">
                    <i class="ti ti-circle"></i>
                  </div>
                  <span class="hide-menu">View Quotations</span>
                </a>
              </li>
              ...
              <li class="sidebar-item">
                <a href="../Public/credit-customers.php" class="sidebar-link sidebar-link2">
                  ...
                  <span class="hide-menu">Customer Due Payment</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a href="../Public/customer-cheque-list.php" class="sidebar-link sidebar-link2">
                  ...
                  <span class="hide-menu">Customer Cheque List</span>
                </a>
              </li>
              <?php
              $date=date("Y-m-d");
              ...
              <li class="sidebar-item">
                <a href="../Public/sales-return.php" class="sidebar-link sidebar-link2">
                  <div class="round-16 d-flex align-items-center justify-content-center">
                    <i class="ti ti-circle"></i>
                  </div>
              ...
              <li class="sidebar-item">
                <a href="../Public/salesReturn.php" class="sidebar-link sidebar-link2">
                  ...
                  <span class="hide-menu">Sales Return </span><span class="badge text-bg-secondary">New</span>
                </a>
              </li>
            </ul>
          </li>
          ...
          <ul aria-expanded="false" class="collapse first-level">
            <li class="sidebar-item">
              <a href="../Public/AddExpenseTypes.php" class="sidebar-link sidebar-link2">
                ...
                <span class="hide-menu">Add Expense Types</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a href="../Public/AddExpenseCategory.php" class="sidebar-link sidebar-link2">
                ...
                <span class="hide-menu">Add Expense Categories</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a href="../Public/AddExpences.php" class="sidebar-link sidebar-link2">
                ...
                <span class="hide-menu">Add Expenses</span>
              </a>
            </li>
          </ul>
          </li>
          <li class="sidebar-item">
            <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
              ...
              <span class="hide-menu">SMS Campaigning</span>
            </a>
            <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
            ...
            <ul aria-expanded="false" class="collapse first-level">
                  ...
                  <ul aria-expanded="false" class="collapse first-level">
                    <li class="sidebar-item">
                      <a href="../Reports/Inventory_summery_report.php" class="sidebar-link sidebar-link3">
                        ...
                        <span class="hide-menu">Inventory Summary</span>
                      </a>
                    </li> 
                    <li class="sidebar-item"> 
                    ...
                    <li class="sidebar-item"> 
                      <a href="../Reports/rpt_inventory_aging.php" class="sidebar-link sidebar-link3">
                        ...
                        <span class="hide-menu">Inventory Aging Report</span>
                      </a>
                    </li>
                    <li class="sidebar-item"> 
                ...
                <li class="sidebar-item">
                  <a href="javascript:void(0)" class="sidebar-link has-arrow sidebar-link2">
                    ...
                    <span class="hide-menu">Categories List</span>
                  </a>
                  <ul aria-expanded="false" class="collapse first-level">
                    <li class="sidebar-item">
                      <a href="../Reports/category-report.php" class="sidebar-link sidebar-link3">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    ...
                    <a href="../Public/category.php" class="sidebar-link sidebar-link3">
                      ...
                      <span class="hide-menu">Add Main Categories</span>
                    </a>
                  </li>
                  <li class="sidebar-item">
            ...
            <ul aria-expanded="false" class="collapse first-level">
              ...
              <li class="sidebar-item">
                <a href="../Public/upload_inventory.php" class="sidebar-link sidebar-link2">
                  ...
                  <span class="hide-menu">Upload Inventory</span>
                </a>
              </li>
               <!-- label print -->
              <li class="sidebar-item">
              ...
              if(isset($feature[0]["is_view"]) && $feature[0]["is_view"]==1)
              {
                ...
                <li class="sidebar-item">
                  <a href="../Public/credit-supplier.php" class="sidebar-link">
                    ...
                    <span class="hide-menu">Supplier Due Payments</span>
                  </a>
                </li>
