      ...
      <div class="modal-content">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <select name="cmb_company_type" id="cmb_company_type" class="form-select dropdown-toggle mb-2">
              <?php 
                $comObj = new Company();
          ...
          <div class="col-lg-6">
            ...
            <?php 
              ...
              {
                $logo_path = "../Assets/Images/Company_logos/Smart_edge_logo.png";
              }
            ?>
        ...
        <div class="modal-footer">
            <button type="submit" name="btn_update_company" class="btn btn-primary" id="btn_update_company">
              Update
            </button>

            <button type="submit" name="btn_save_company" class="btn btn-primary" id="btn_save_company">
              Save
            </button>

            <button type="button" class="btn btn-danger" data-bs-dismiss="modal" id="close_company_modal">
              Close
            </button>
        </div>
