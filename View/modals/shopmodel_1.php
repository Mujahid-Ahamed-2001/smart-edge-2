                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 rounded">
                                    <img src="../Assets/Images/SystemLogo/Smart_edge_logo_3.png" id="img_shop_logo" class="shadow img-fluid mx-auto d-block mt-2 p-2 rounded bordered" alt="Shop Logo" accept="image/png, image/gif, image/jpeg">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 rounded">
                                    <img src="../Assets/Images/SystemLogo/Smart_edge_logo_3.png" id="img_receipt_logo" class="shadow img-fluid mx-auto d-block mt-2 p-2 rounded bordered" alt="Shop Logo" accept="image/png, image/gif, image/jpeg">
                                </div>
                            </div>
                        </div>
