<script>
  $(document).ready(function() {
    $(document).on("click", "#btn_close_bill_counter", function() {
      ...
      <div class="modal-body">
        ...
        <form action="../Controller/counterController.php" method="POST">
          <div class="row">
            ...
            <div class="col-md-6">
                <label for="start_amount" class="form-label mt-3">Start Amount</label>
                <input type="number" step="0.01" class="form-control" name="start_amount" id="start_amount" placeholder="0.00">

                <label for="end_amount" class="form-label mt-3">End Amount</label>
                <input type="number" step="0.01" class="form-control" name="end_amount" id="end_amount" placeholder="0.00" disabled>
