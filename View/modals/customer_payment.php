  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p id="p_sup_details"></p>

        <table class="table" id="tbl_invoice_details"></table>

        <div class="row mt-3">

            <input type="hidden" name="hide_invoice_header_id" id="hide_invoice_header_id" value="0">
            <input type="hidden" name="hide_credit_supplier_id" id="hide_credit_supplier_id" value="0">
            <input type="hidden" name="hide_invoice_total" id="hide_invoice_total" value="0">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <button type="submit" name="btn_submit_payment" class="btn btn-primary float-end">Submit Payment</button>
            </div>
        </div>
        </form>
      </div>
