            ...
            else
            {
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <!-- close counter -->
                  <p>
                      Start Amount : <b><?php echo number_format($start_amount, 2, ".",",");?></b><br>
                      Net Balance : <b><?php echo number_format($counter_total, 2, ".",",");?></b><br>
                      End Amount : <b><?php echo number_format($end_balance, 2, ".",",");?></b>
                  </p>
                  ...
                  <!-- sales by paymethods -->
                   <?php 
                    ...
                    WHERE CashCounter_CCID = ".$bill_counter_id." AND invoiceheader.InvStat=1 AND (SELECT COUNT(*) AS COUNT FROM invoicedetails id WHERE id.InvoiceHeader_IHID = invoiceheader.IHID) > 0 GROUP BY transactions.paymethod_PMID;";
                    ...
                    foreach($payData as $row)
                    {
                      ?>
                      <p style="margin: 0px;">
                        <?php echo $row['PaymethodName'] . " : <b>" . number_format($row['transfer_amount'], 2, ".", ",") . "</b>";?> <br>
                      </p>
                      <?php 
                    }//foreach
                   ?>
