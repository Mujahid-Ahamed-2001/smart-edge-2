                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="m-2">
                                ...
                                <input type="tel" name="EmailAddress" id="EmailAddress" placeholder="Eg: Example@next-edge.lk" class="required form-control mb-2">
                                <span class="text-danger" id="require-span" style="display:none;">This Field is Required</span>
                        ...
                        <h6 class="text-center w-100 mb-3 mt-3" style="color: #fff;">New Shop Features</h6>
                        <div class="col-md-12 row mb-3" id="ShopFeatures">
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <label class="form-check-label" for="chk_category">Category</label>
                                    <input class="form-check-input" name="chk_category" type="checkbox" id="chk_category">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3 rounded">
                                <img src="../Assets/Images/SystemLogo/Smart_edge_logo_3.png" id="img_shop_logo"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3 rounded">
                                <img src="../Assets/Images/SystemLogo/Smart_edge_logo_3.png" id="img_receipt_logo"
                                    class="shadow img-fluid mx-auto d-block mt-2 p-2 rounded bordered" alt="Shop Logo"
                                    accept="image/png, image/gif, image/jpeg">
                            </div>
                        </div>
